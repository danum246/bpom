...
$pdf->Cell(3,7,':',0,0,'L');
$pdf->Cell(90,7,show_pgn($rowdata->pangan_umum),0,1,'L');
...
$pdf->Cell(90,8,'Jumlah korban meninggal '.total($rowdata->kd_keluhan,'2').' orang',0,1,'L');
