...
insert  into `tbl_gejala`(`id_gejala`,`kd_gejala`,`gejala`) values (1,'GJ-01','Mual'),(2,'Gj-02','Diare'),(3,'GJ-03','Demam'),(4,'GJ-04','Pusing'),(5,'GJ-05','Muntah'),(6,'GL-1','Batuk'),(8,'GL-3','Mencret'),(9,'GL-2','Panas'),(11,'GL-4','Meriang');
...
insert  into `tbl_racun`(`id_racun`,`kd_racun`,`racun`,`keterangan`,`inkubasi_rata`,`inkubasi_pendek`,`inkubasi_tinggi`,`organ_id`) values (6,'RC-002','Sianida','-',30,10,20,NULL),(5,'RC-001','Arsenic','-',10,5,20,NULL),(7,'RC-003','Klorin','-',20,10,40,NULL),(8,'RC-004','Hidrogen SIanida','-',20,10,50,NULL);
...
insert  into `tbl_racun_gejala`(`no`,`kd_racun`,`kd_gejala`) values (14,'RC-002','GL-1'),(13,'RC-002','GJ-03'),(12,'RC-002','GJ-01'),(11,'RC-001','GJ-05'),(10,'RC-001','GJ-04'),(9,'RC-001','GJ-01'),(15,'RC-002','GL-4'),(16,'RC-003','GJ-04'),(17,'RC-003','GJ-05'),(18,'RC-003','GL-3'),(19,'RC-004','GJ-01'),(20,'RC-004','Gj-02');
